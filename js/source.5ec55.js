...
var _moment = _interopRequireDefault(__webpack_require__(18));
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(0),m=__webpack_require__(27),p=__webpack_require__(4),v=__webpack_require__(7),da=__webpack_require__(28),ea=__webpack_require__(29),fa=__webpack_require__(30),ha=__webpack_require__(6);
...
var _Scheduler = _interopRequireDefault(__webpack_require__(38));
...
var _stylesM = _interopRequireDefault(__webpack_require__(9));

var _REST = __webpack_require__(10);

var _Header = _interopRequireDefault(__webpack_require__(62));

var _Footer = _interopRequireDefault(__webpack_require__(63));

var _TaskCreator = _interopRequireDefault(__webpack_require__(72));

var _TaskList = _interopRequireDefault(__webpack_require__(73));
...
class Scheduler extends _react.Component {
  constructor(props) {
    ...
    _defineProperty(this, "_deleteTask", id => {
      _REST.api.removeTask(id).then(response => response.data).then(() => {
        this.setState({
    ...
    _defineProperty(this, "_updateTask", payload => {
      _REST.api.updateTask(Array.isArray(payload) ? payload : [payload]).then(response => response.data).then(updatedTasks => {
        const {
          tasks
        } = this.state;
        this.setState({
          tasks: [...updatedTasks.data, ...tasks].filter((obj, pos, arr) => {
    ...
    _defineProperty(this, "_searchHandle", e => {
      this.setState({
        messagePattern: e.target.value
      });
    });

    _defineProperty(this, "_completeAllTasks", () => {
    ...
    _defineProperty(this, "_createTask", message => {
      _REST.api.createTask({
        message
      }).then(response => response.data).then(task => {
        this.setState({
  ...
  render() {
    ...
    }, _react.default.createElement("main", null, _react.default.createElement(_Header.default, {
      searchHandle: this._searchHandle
    }), _react.default.createElement("section", null, _react.default.createElement(_TaskCreator.default, {
      createTask: this._createTask
    }), _react.default.createElement(_TaskList.default, {
      deleteTask: this._deleteTask,
      tasks: (0, _helpers.sortTasksByGroup)(tasks).filter(task => task.message.includes(messagePattern)),
...
var _axios = _interopRequireDefault(__webpack_require__(42));
...
class Header extends _react.PureComponent {
  render() {
    ...
    return _react.default.createElement("header", null, _react.default.createElement("h1", null, "\u041F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0449\u0438\u043A \u0437\u0430\u0434\u0430\u0447"), _react.default.createElement("input", {
...
var _Checkbox = _interopRequireDefault(__webpack_require__(16));
...
class Footer extends _react.PureComponent {
  render() {
    ...
    return _react.default.createElement("footer", null, _react.default.createElement(_Checkbox.default, {
      checked: checked,
      className: _stylesM.default.completeAllTasks,
      color1: "#3B8EF3",
      color2: "#FFF",
      onClick: completeAllTasks
    }), _react.default.createElement("span", null, "\u0412\u0441\u0435 \u0437\u0430\u0434\u0430\u0447\u0438 \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u044B"));
  }
...
// Instruments
// import Styles from "./styles.m.css";
class TaskCreator extends _react.PureComponent {
  constructor(props) {
    super(props);
    ...
    this.myRef = _react.default.createRef();
  }
  ...
  render() {
    ...
    return _react.default.createElement("form", {
      onSubmit: e => this._handleClick(e)
    }, _react.default.createElement("input", {
      maxLength: "50",
      placeholder: "\u041E\u043F\u0438\u0441a\u043D\u0438\u0435 \u043C\u043E\u0435\u0439 \u043D\u043E\u0432\u043E\u0439 \u0437\u0430\u0434\u0430\u0447\u0438",
      ref: this.myRef,
      type: "text"
    }), _react.default.createElement("button", null, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443"));
  }
...
var _Task = _interopRequireDefault(__webpack_require__(74));
...
// Instruments
// import Styles from "./styles.m.css";
class TaskList extends _react.Component {
  constructor(props) {
    super(props);
  }
...
var _stylesM = _interopRequireDefault(__webpack_require__(22));

var _TaskActions = _interopRequireDefault(__webpack_require__(76));
...
class Task extends _react.Component {
  constructor(props) {
    super(props);
    ...
    _defineProperty(this, "_deleteTask", () => {
      const {
        id,
        deleteTask
      } = this.props;
    ...
    _defineProperty(this, "_toggleComplete", () => {
  ...
  render() {
    ...
    return _react.default.createElement("li", {
      ...
      type: "text",
      value: message
    })), _react.default.createElement(_TaskActions.default, {
      deleteTask: this._deleteTask,
      editable: !disabled,
...
var _Edit = _interopRequireDefault(__webpack_require__(77));

var _Remove = _interopRequireDefault(__webpack_require__(78));

var _Star = _interopRequireDefault(__webpack_require__(79));
...
// Core
// Instruments
class TaskActions extends _react.PureComponent {
  render() {
    const {
      editable,
      completed,
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.5ec55.js.map